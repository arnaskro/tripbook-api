...
describe 'Trips & Bookings Module' do
  ...
  describe "Get" do
    ...
    it "gets the bookings made by the user" do
      get '/v1/bookings', headers: @user.create_new_auth_token
    ...
    it "gets the bookings made for the local and his trips" do
      get '/v1/bookings', headers: @user.create_new_auth_token
      expect(json["total"]).to eq(0)
      ...
      get '/v1/bookings', headers: @local.user.create_new_auth_token
      expect(json["total"]).to eq(1)
    end
  end
